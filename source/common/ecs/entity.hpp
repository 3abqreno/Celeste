...
namespace our
{
    ...
    public:
        ...
        T *getComponent()
        {
            ...
            return nullptr; // Return nullptr if no component of type T was found
        }
        ...
        void deleteComponent()
        {
            ...
            {
                T *castedComp = dynamic_cast<T *>(*it); // Attempt to cast the component to type T*
                if (castedComp != nullptr)              // Check if the cast was successful
                {
                    delete castedComp;    // Delete the component
                    components.erase(it); // Remove it from the components list
                    return;               // Exit the function after deleting the component
                }
            }
        }
